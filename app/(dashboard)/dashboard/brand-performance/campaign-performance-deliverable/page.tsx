...
import SocialCampaignAnalytics from '@/components/brand-performance/campaign-performance-deliverable/SocialCampaignAnalytics';
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Campaign Performance – Deliverable</h1>
          <p className="text-muted-foreground">Realistic deliverable version based on current capabilities</p>
        </div>
